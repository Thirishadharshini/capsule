...
//    vector<int> v;
//    Mat image;
//    DIR* dir = opendir("C:\\office works\\color_check\\seperated\\Image_20241014110326593.jpg\\");
//    struct dirent* ent;
//    int i = -1;
...
//            string filePath = string("C:\\office works\\color_check\\seperated\\Image_20241014110326593.jpg\\") + ent->d_name;
...
//            if (avg_val > 79 && avg_val < 100 && avg_val_sat>160 &&avg_val_sat<185)
//            {
//                imwrite("C:\\office works\\color_check\\green\\sat and hue\\Image_20241014110326593.jpg light_green\\" + string(ent->d_name), image);
//            }
//            else
//                imwrite("C:\\office works\\color_check\\green\\sat and hue\\Image_20241014110326593.jpg dark_green\\" + string(ent->d_name), image);
//            waitKey(0);
//        }
//        i++;
//    }
