...
class capsule_shadow {
public:
	static void remove_shadows()
	{
		...
		Mat result;
		namedWindow("result image", WINDOW_FREERATIO);
		namedWindow("result hsv image", WINDOW_FREERATIO);
		namedWindow("og image", WINDOW_FREERATIO);
